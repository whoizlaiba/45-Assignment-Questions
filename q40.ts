...
console.log(make_album("Zara Khan","Sufi Serenade",35))
console.log(make_album("by Ali Abbas","Urban Rhythms" ,50))
console.log(make_album("Aisha Malik","Desert Tales",30))
